...
export type AppSettings = { permissionMode: PermissionMode; fontSize: FontSize; theme: ThemeMode; historyRefreshIntervalSeconds: number; codexPath?: string; model?: string; reasoningEffort?: string; projectPaths?: string[] };
